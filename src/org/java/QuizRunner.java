...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        String q3 = "Which poem did history making poet Amanda Gorman recite at the US presidential inaugration in 2021?";
        Choice[] q3Choices = new Choice[]{
                new Choice("The Hill We Climb", true),
                new Choice("The Miracle Morning"),
                new Choice("We Rise"),
                new Choice("New Day's Lyric")
        };
        MultipleChoiceQuestions question3 = new MultipleChoiceQuestions(q3, q3Choices);
